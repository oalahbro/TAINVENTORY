	...
	<div class="wrapper">
		...
		<div class="main-header" data-background-color="green">
			...
			<div class="logo-header">
				<a href="<?php echo e(base_url()); ?>" class="logo">
			...
			<nav class="navbar navbar-header navbar-expand-lg">
				...
				<div class="container-fluid">
					<div class="collapse" id="search-nav">
						<form class="navbar-left navbar-form nav-search mr-md-3" method="POST" action="<?php echo e(base_url()); ?>admin/admin/search">
						...
						<li class="nav-item dropdown hidden-caret">
							...
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								...
								<li>
									...
									<a class="dropdown-item" href="<?php echo e(base_url()); ?>admin/admin/profile">My Profile</a>
									<div class="dropdown-divider"></div>
				...
				<div class="sidebar-content">
					<div class="user">
						...
						<div class="info">
							...
							<div class="collapse in" id="collapseExample">
								<ul class="nav">
									<li>
										<a href="<?php echo e(base_url()); ?>admin/admin/profile">
					...
					<ul class="nav">
						...
						<?php else: ?> 
							<li class="nav-item active">
						<?php endif; ?>
							<a href="<?php echo e(base_url()); ?>admin/admin/report">
