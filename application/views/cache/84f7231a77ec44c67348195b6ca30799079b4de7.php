			...
			<nav class="navbar navbar-header navbar-expand-lg">
				...
				<div class="container-fluid">
					<div class="collapse" id="search-nav">
						<form class="navbar-left navbar-form nav-search mr-md-3" action="<?php echo e(base_url()); ?>buyer/buyer/search" method="POST">
						...
						<li class="nav-item dropdown hidden-caret">
							...
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								...
								<li>
									...
									<a class="dropdown-item" href="<?php echo e(base_url()); ?>buyer/buyer/profile">My Profile</a>
									<div class="dropdown-divider"></div>
				...
				<div class="sidebar-content">
					<div class="user">
						...
						<div class="info">
							...
							<div class="collapse in" id="collapseExample">
								<ul class="nav">
									<li>
										<a href="<?php echo e(base_url()); ?>buyer/buyer/profile">
					...
					<ul class="nav">
						...
						<?php else: ?> 
							<li class="nav-item active">
						<?php endif; ?>
							<a href="<?php echo e(base_url()); ?>buyer/buyer/report">
