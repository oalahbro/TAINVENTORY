			...
			<nav class="navbar navbar-header navbar-expand-lg">
				...
				<div class="container-fluid">
					<div class="collapse" id="search-nav">
						<form class="navbar-left navbar-form nav-search mr-md-3" action="{{ base_url() }}buyer/buyer/search" method="POST">
					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
						...
						<li class="nav-item dropdown hidden-caret">
							...
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<li>
									<div class="user-box">
										<div class="avatar-lg"><img src="{{  $planet['user']['img'] }}" alt="image profile" class="avatar-img rounded" id="header-img1"></div>
										<div class="u-text">
								...
								<li>
									...
									<a class="dropdown-item" href="{{ base_url() }}buyer/buyer/profile">My Profile</a>
									<div class="dropdown-divider"></div>
				...
				<div class="sidebar-content">
					<div class="user">
						<div class="avatar-sm float-left mr-2">
							<img src="{{  $planet['user']['img'] }}" alt="..." class="avatar-img rounded-circle" id="header-img2">
						</div>
						<div class="info">
							...
							<div class="collapse in" id="collapseExample">
								<ul class="nav">
									<li>
										<a href="{{ base_url() }}buyer/buyer/profile">
					...
					<ul class="nav">
						...
						@else 
							<li class="nav-item active">
						@endif
							<a href="{{ base_url() }}buyer/buyer/report">
