		...
		<div class="container container-signup animated fadeIn">
			<h3 class="text-center">Sign In To Admin</h3>
				...
				<div class="login-account">
					...
					<a href="#" id="show-signin" class="link">Sign Up</a>
				</div>
			</div>
		</div>
            ...
            <form action="/login/addAdmin" method="post">
                ...
                <div class="form-group form-floating-label">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="username" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" required value="<?= $username?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group form-floating-label">
                        <input  id="fullname" name="nama_Admin" type="text" class="form-control input-border-bottom" required value="<?= $nama_Admin?>">
                    ...
                    <div class="form-group form-floating-label">
                        <input  id="passwordsignin" name="password" type="password" class="form-control input-border-bottom" required value="<?= $password?>">
                    ...
                    <select class="form-control input-pill" name="level" id="pillSelect">
                        <?php 
                        if($level == 1){
                            echo '<option value="1" hidden>Admin</option>';
                        }
                        if($level == 2){
                            echo '<option value="2" hidden>Buyer</option>';
                        }
                        if($level == 3){
                    ...
                    <div class="form-action">
                        <a href="#" id="show-signup" class="btn btn-danger btn-rounded btn-login mr-3">Cancel</a>
